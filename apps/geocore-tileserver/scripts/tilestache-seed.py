...
West Oakland (http://sta.mn/ck) in the "osm" layer, for zoom levels 12-15:
    ...
    tilestache-seed.py -b 14.5378487381 121.0940081322 14.657455158 120.9786516868 -c /apps/tileserver/conf/tilestache/tilestache.cfg -e pbf -l osmpoints 14 15
